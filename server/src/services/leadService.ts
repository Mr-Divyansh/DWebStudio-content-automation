...
export class LeadService {
  ...
  /**
   * Phase 1 (P1) — human-triggered public research for one lead.
   * Delegates to ResearchService so there is a single research implementation.
   */
  static async runResearch(leadId: string, options: ResearchOptions = {}) {
    return ResearchService.researchLead(leadId, options);
  }
